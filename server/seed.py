...
######products####
    ...
    product7= Product(name='Telecaster', brand='Fender', price=1799.99, description='Telecaster Maple Fingerboard, Butterscotch Blonde',image='https://cdn.shopify.com/s/files/1/0916/0836/products/46431_Fender_Telecaster_US19037791_2_7e8cd5a5-1b65-4383-96db-52149e3e27d8_4000x@3x.progressive.jpg?v=1571866345') 
    product8= Product(name='SM57', brand='Sure', price=99.99, description='Cardioid Dynamic Instrument Microphone',image='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnibIwHxO0IEVoW_DYMKjCWTRV8ttsS5BLzg&usqp=CAU')
    product9= Product(name='U57', brand='Neumann', price=3295.00, description='neumann u 87 ai large-diaphragm condenser microphone,nickel', image='https://m.kitmonsters.com/05127-0470-u87ai.large.jpg')
    product10= Product(name='American Professional II Precision Bass', brand='Fender', price=1749.00, description='3-color Sunburst with Rosewood Fingerboard', image='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_Yl6dK-EQi4prcmAfXhoU6acnb3joU5UWSg&usqp=CAU')
