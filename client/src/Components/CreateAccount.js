...
function CreateAccount({ currentCustomer, setCurrentCustomer }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object({
      ...
      firstname: yup.string().required("Must enter a first name").max(15, 'Must be 15 characters max'),
      lastname: yup.string().required("Must enter a last name").max(15, 'Must be 15 characters max'),
      address: yup.string().required("Must enter a street address").max(200, 'Must be 200 characters max'),
